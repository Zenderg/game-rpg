  ...
  _createClass(LoadScene, [{
    ...
    value: function preload() {
      ...
      this.load.on('complete', function () {
        _this.scene.start(_CST.CST.SCENES.MENU, "я создался");
      });
    }
  }, {
    key: "create",
...
},{"../CST":"src/CST.ts"}],"src/scenes/MenuScene.js":[function(require,module,exports) {
"use strict";
...
function (_Phaser$Scene) {
  ...
  _createClass(MenuScene, [{
    ...
    value: function create() {
      ...
      var cat = this.add.sprite(100, 100, 'cat');
      this.anims.create({
        key: 'walk',
        repeat: -1,
        frameRate: 10,
      ...
      playButton.on('pointerover', function (data) {
        cat.setVisible(true);
        cat.x = playButton.x - playButton.width;
        cat.y = playButton.y;
        cat.play('walk');
      });
      playButton.on('pointerout', function (data) {
        cat.setVisible(false);
      });
      playButton.on('pointerup', function (data) {
        console.log("Открыть ворота");
      });
    }
  }]);
...
},{"../CST":"src/CST.ts"}],"src/main.js":[function(require,module,exports) {
"use strict";
...
},{"./scenes/LoadScene":"src/scenes/LoadScene.ts","./scenes/MenuScene":"src/scenes/MenuScene.ts"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
